...
# If build is successful then the jar is in ./target/day18-0.0.1-SNAPSHOT.jar
...
COPY --from=builder /app/target/noticeboard-0.0.1-SNAPSHOT.jar noticeboardapp.jar
